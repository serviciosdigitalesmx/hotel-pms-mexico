# Hypervelocity checkpoint batch-4
...
2026-08-22T05:05:00.126-06:00  INFO 96428 --- [guest-service] [ionShutdownHook] [                                                 ] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Shutdown initiated...
2026-08-22T05:05:00.129-06:00  INFO 96428 --- [guest-service] [ionShutdownHook] [                                                 ] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Shutdown completed.
...
[Incubating] Problems report is available at: file:///Users/usuario/.ralph-hotel/hypervelocity-worktrees/checkpoint-batch-4-ttyld1i6/build/reports/problems/problems-report.html
...
exit=1
        [36m</thead>[39m
            ...
            [36m>[39m
              [36m<tr>[39m
                [36m<td[39m
                  [33mclass[39m=[32m"py-8 text-center text-sm font-body text-on-surface-variant"[39m
                  [33mcolspan[39m=[32m"9"[39m
                [36m>[39m
                  [0mno_active_stays[0m
                [36m</td>[39m
              [36m</tr>[39m
            [36m</tbody>[39m
          [36m</table>[39m
...
[90m [2m❯[22m ../../../../Desktop/HOTEL-PMS/frontend/node_modules/@testing-library/dom/dist/query-helpers.js:[2m76:38[22m[39m
...
[36m [2m❯[22m src/pages/Stays.test.tsx:[2m239:19[22m[39m
    [90m237|[39m     [34mrender[39m([33m<[39m[33mStays[39m [33m/[39m[33m>[39m)[33m;[39m
    [90m238|[39m     await waitFor(() => expect(screen.getByText('no_active_stays')).to…
    [90m239|[39m     expect(screen.getByText('download_json_export')).toBeInTheDocument…
    [90m   |[39m                   [31m^[39m
    [90m240|[39m   })[33m;[39m
    [90m241|[39m
...
[41m[1m FAIL [22m[49m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould render JSON export button for OWNER
[31m[1mTestingLibraryElementError[22m[39m: Unable to find an element with the text: download_json_export. This could be because the text is broken up by multiple elements. In this case, you can provide a function for your text matcher to make your matcher more flexible.
      ...
      [36m>[39m
        ...
        [36m>[39m
          ...
          [36m<button[39m
            ...
            [33mclass[39m=[32m"flex items-center justify-center w-10 h-10 rounded-shape-full border border-outline text-on-surface-variant hover:bg-primary/[0.08] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 transition-colors"[39m
            [33mtype[39m=[32m"button"[39m
          [36m>[39m
            [36m<span[39m
              [33maria-hidden[39m=[32m"true"[39m
...
[90m [2m❯[22m ../../../../Desktop/HOTEL-PMS/frontend/node_modules/@testing-library/dom/dist/query-helpers.js:[2m52:17[22m[39m
[90m [2m❯[22m ../../../../Desktop/HOTEL-PMS/frontend/node_modules/@testing-library/dom/dist/query-helpers.js:[2m95:19[22m[39m
[36m [2m❯[22m src/pages/Stays.test.tsx:[2m267:19[22m[39m
    [90m265|[39m     [34mrender[39m([33m<[39m[33mStays[39m [33m/[39m[33m>[39m)[33m;[39m
    [90m266|[39m     await waitFor(() => expect(screen.getByText('no_active_stays')).to…
    [90m267|[39m     expect(screen.getByText('download_json_export')).toBeInTheDocument…
    [90m   |[39m                   [31m^[39m
    [90m268|[39m   })[33m;[39m
    [90m269|[39m
...
[2m      Tests [22m [1m[31m21 failed[39m[22m[2m | [22m[1m[32m876 passed[39m[22m[90m (897)[39m
[2m   Start at [22m 05:05:25
[2m   Duration [22m 89.51s[2m (transform 16.10s, setup 23.99s, import 180.51s, tests 208.77s, environment 164.05s)[22m
...
dist/assets/PasswordVisibilityToggle-BDVhR0Vf.js              0.62 kB │ gzip:  0.40 kB
...
dist/assets/SettingsPageHeader-CtF30lzm.js                    0.77 kB │ gzip:  0.42 kB
...
