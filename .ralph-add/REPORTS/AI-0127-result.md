...
@@ -235,6 +240,18 @@ export const Stays = memo(() => {
         </div>
       </div>
 
+      <AlloggiatiReportSection isAdminOrOwner={isAdminOrOwner} />
+
+      {filteredStays.some((stay) => stay.alloggiatiSendFailed) && (
+        <div role="status" className="flex flex-col items-start gap-1">
+          {filteredStays.filter((stay) => stay.alloggiatiSendFailed).map((stay) => (
+            <span key={stay.id} title={stay.alloggiatiFailureReason ?? undefined}>
...
index 633d5a614d0b3417253f9aec413c344acf3a6854..d3b58291112c65e443cf0a9422087448a017bc2d
...
codex
Implementado en [Stays.tsx](/Users/usuario/.ralph-hotel/hypervelocity-worktrees/AI-0127-a_bp2fom/frontend/src/pages/Stays.tsx):

- Muestra `alloggiati_failed` cuando `alloggiatiSendFailed=true`.
- Usa `alloggiatiFailureReason` como tooltip.
- No altera el retry existente ni contratos backend.
- `git diff --check`: OK.
- TypeScript: OK.
- Tests/build Vite bloqueados por `EPERM` preexistente al escribir `frontend/node_modules/.vite-temp`.
diff --git a/frontend/src/pages/Stays.tsx b/frontend/src/pages/Stays.tsx
index 633d5a614d0b3417253f9aec413c344acf3a6854..d3b58291112c65e443cf0a9422087448a017bc2d
--- a/frontend/src/pages/Stays.tsx
+++ b/frontend/src/pages/Stays.tsx
...
> frontend@0.0.0 test
> vitest run --run src/pages/Stays.test.tsx --reporter=verbose


[1m[30m[46m RUN [49m[39m[22m [36mv4.1.5 [39m[90m/Users/usuario/.ralph-hotel/hypervelocity-worktrees/AI-0127-a_bp2fom/frontend[39m

 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show loading spinner initially[32m 46[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould render stays on success[32m 87[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show empty state when no stays[32m 13[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show FAILED badge for a stay with a failed Alloggiati submission[32m 16[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show error on failure[32m 14[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show invoice-failed badge and retry, clearing the flag on success[32m 214[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould show checkout-email-failed badge and retry on failure keeps the badge[32m 95[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould render page title[32m 7[2mms[22m[39m
Not implemented: HTMLCanvasElement's getContext() method: without installing the canvas npm package
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould filter stays by room number on search input[33m 337[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould filter stays by status chip[32m 90[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould have no accessibility violations[32m 199[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould not render JSON export button for RECEPTIONIST[32m 10[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould render JSON export button for ADMIN[32m 10[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould navigate to guests page when guest name is clicked[32m 77[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mshould render JSON export button for OWNER[32m 9[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mrenders the expected check-out date column[32m 10[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22msorts by expected check-out date when the sort field is changed[32m 127[2mms[22m[39m
 [32m✓[39m src/pages/Stays.test.tsx[2m > [22mStays[2m > [22mapplies statusFilter, sortField and sortDir from navigation state on initial load[32m 11[2mms[22m[39m

[2m Test Files [22m [1m[32m1 passed[39m[22m[90m (1)[39m
[2m      Tests [22m [1m[32m18 passed[39m[22m[90m (18)[39m
[2m   Start at [22m 05:54:10
[2m   Duration [22m 2.84s[2m (transform 114ms, setup 112ms, import 550ms, tests 1.38s, environment 652ms)[22m
...
dist/assets/PasswordVisibilityToggle-eN8kUbM7.js              0.62 kB │ gzip:  0.40 kB
...
dist/assets/SettingsPageHeader-B7NzEw0p.js                    0.77 kB │ gzip:  0.42 kB
...
dist/assets/M3SegmentedRow-D45QJExR.js                        1.31 kB │ gzip:  0.71 kB
dist/assets/billingService-CNiCAPFQ.js                        1.33 kB │ gzip:  0.56 kB
dist/assets/SettingsProfile-6qYU6hFp.js                       1.33 kB │ gzip:  0.64 kB
dist/assets/dashboardService-DQPTy6kv.js                      1.34 kB │ gzip:  0.68 kB
dist/assets/Login-B_8tA1dj.js                                 1.58 kB │ gzip:  0.82 kB
dist/assets/M3Dialog-BqKXRmhE.js                              1.71 kB │ gzip:  0.81 kB
dist/assets/M3TextField-CwD3aJfy.js                           1.84 kB │ gzip:  0.91 kB
dist/assets/SettingsAccessibility-5rKj22oe.js                 2.46 kB │ gzip:  1.05 kB
dist/assets/Settings-IUsY6muK.js                              2.47 kB │ gzip:  1.01 kB
dist/assets/SettingsPassword-DnWTVWf5.js                      3.02 kB │ gzip:  1.32 kB
dist/assets/SettingsAppearance-CNBaBC_E.js                    3.07 kB │ gzip:  1.36 kB
dist/assets/RoomSelection-DCnNOUkV.js                         3.62 kB │ gzip:  1.50 kB
dist/assets/CheckInForm-CMN2ojZB.js                           5.30 kB │ gzip:  2.18 kB
dist/assets/HotelProfile-NpULbIox.js                          5.33 kB │ gzip:  2.02 kB
dist/assets/Dashboard-i-a4qNyi.js                             5.91 kB │ gzip:  2.10 kB
dist/assets/Housekeeping-COWinfYY.js                          6.04 kB │ gzip:  2.12 kB
dist/assets/OwnerDashboard-C-s1fBqd.js                        6.81 kB │ gzip:  2.09 kB
dist/assets/WalkInCheckInForm-DQgxEHk4.js                     7.35 kB │ gzip:  2.47 kB
dist/assets/Quotations-CHSQ-qAR.js                            7.72 kB │ gzip:  2.56 kB
dist/assets/SettingsSystem-DVC861r2.js                        7.88 kB │ gzip:  2.49 kB
dist/assets/ReservationForm-BhWWDck2.js                       9.85 kB │ gzip:  3.36 kB
dist/assets/Reservations-CurqEV3O.js                         10.43 kB │ gzip:  3.46 kB
dist/assets/authStore-D_EzjumG.js                            10.53 kB │ gzip:  4.24 kB
dist/assets/GuestFieldSection-BWgN0fZF.js                    10.76 kB │ gzip:  3.08 kB
dist/assets/QuotationForm-DpesOepd.js                        11.28 kB │ gzip:  3.81 kB
dist/assets/QuotationDetail-CvYIbb3r.js                      11.86 kB │ gzip:  3.17 kB
dist/assets/AdminUsers-R51Zf64r.js                           13.15 kB │ gzip:  3.29 kB
dist/assets/RateCalendar-D-dWX9iX.js                         13.50 kB │ gzip:  4.54 kB
dist/assets/Stays-CmiMKUiQ.js                                14.05 kB │ gzip:  4.14 kB
dist/assets/Assistant-BgTC9juL.js                            15.87 kB │ gzip:  5.18 kB
dist/assets/Guests-CdIvHVAs.js                               16.07 kB │ gzip:  4.53 kB
dist/assets/Billing-BO3xDnKY.js                              17.74 kB │ gzip:  4.89 kB
dist/assets/Restaurant-CxC1OfNL.js                           21.71 kB │ gzip:  5.61 kB
dist/assets/Rooms-HHhMtH_w.js                                25.46 kB │ gzip:  5.51 kB
dist/assets/it-ChNJib2b.js                                   32.13 kB │ gzip:  8.15 kB
dist/assets/schemas-Bo3zeGyq.js                              69.31 kB │ gzip: 18.48 kB
dist/assets/CalendarPlanning-eZUJ6rkw.js                    195.75 kB │ gzip: 57.97 kB
dist/assets/api-C5oH9PS7.js                                 206.61 kB │ gzip: 66.32 kB
dist/assets/index-BpTiG2KD.js                               284.35 kB │ gzip: 90.49 kB
