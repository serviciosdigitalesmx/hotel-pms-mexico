...
div[39m
      ...
      [36m>[39m
        ...
        [36m</div>[39m
        [36m<div[39m
          [33mclass[39m=[32m"bg-surface border border-outline-variant rounded-shape-md p-5"[39m
        [36m>[39m
          [36m<div[39m
          ...
          [36m>[39m
            ...
            [36m</span>[39m
            [36m<h2[39m
              [33mclass[39m=[32m"text-sm font-display font-semibold text-on-surface"[39m
            [36m>[39m
              [0mpolice_report_title[0m
            [36m</h2>[39m
          [36m</div>[39m
          [36m<p[39m
            [33mclass[39m=[32m"text-xs font-body text-on-surface-variant mb-4"[39m
          [36m>[39m
            [0mpolice_report_desc[0m
          [36m</p>[39m
          [36m<div[39m
            [33mclass[39m=[32m"flex flex-col sm:flex-row items-end gap-3"[39m
          [36m>[39m
            [36m<div[39m
            ...
            [36m>[39m
              [36m<label[39m
                ...
                [33mfor[39m=[32m"alloggiati-date"[39m
              [36m>[39m
                [0mcheck_in_date[0m
              [36m</label>[39m
              [36m<input[39m
                ...
                [33mid[39m=[32m"alloggiati-date"[39m
                [33mtype[39m=[32m"date"[39m
                [33mvalue[39m=[32m"2026-08-22"[39m
              [36m/>[39m
            [36m</div>[39m
            [36m<button[39m
              [33mclass[39m=[32m"inline-flex items-center justify-center gap-2 px-6 h-10 rounded-shape-full text-sm font-medium font-body transition-all
        ...
        "[39m
              [33mid[39m=[32m"generate-alloggiati-btn"[39m
            [36m>[39m
              [36m<span[39m
                [33maria-hidden[39m=[32m"true"[39m
                [33mclass[39m=[32m"material-symbols-outlined"[39m
...
[2m   Start at [22m 05:35:49
[2m   Duration [22m 4.09s[2m (transform 130ms, setup 126ms, import 611ms, tests 2.40s, environment 795ms)[22m
...
dist/assets/PasswordVisibilityToggle-D4LCvaah.js              0.62 kB │ gzip:  0.39 kB
...
dist/assets/SettingsPageHeader-BOs6XPwx.js                    0.77 kB │ gzip:  0.42 kB
...
dist/assets/M3SegmentedRow-B7P7QPaj.js                        1.31 kB │ gzip:  0.71 kB
dist/assets/billingService-CNiCAPFQ.js                        1.33 kB │ gzip:  0.56 kB
dist/assets/SettingsProfile-CkT0i0kd.js                       1.33 kB │ gzip:  0.64 kB
dist/assets/dashboardService-DnwKDK8S.js                      1.34 kB │ gzip:  0.68 kB
dist/assets/Login-CXxpWctf.js                                 1.58 kB │ gzip:  0.82 kB
dist/assets/M3Dialog-DpsJr3Hr.js                              1.71 kB │ gzip:  0.81 kB
dist/assets/M3TextField-DmlcAp3y.js                           1.84 kB │ gzip:  0.91 kB
dist/assets/SettingsAccessibility-9vH0nNZC.js                 2.46 kB │ gzip:  1.05 kB
dist/assets/Settings-BUp5NwP7.js                              2.47 kB │ gzip:  1.00 kB
dist/assets/SettingsPassword-CNIaE5SE.js                      3.02 kB │ gzip:  1.32 kB
dist/assets/SettingsAppearance-By3Rr7qN.js                    3.07 kB │ gzip:  1.36 kB
dist/assets/RoomSelection-B-3Q4Vhg.js                         3.62 kB │ gzip:  1.50 kB
dist/assets/CheckInForm-BEqY8kKT.js                           5.30 kB │ gzip:  2.18 kB
dist/assets/HotelProfile-B5HWMd9p.js                          5.33 kB │ gzip:  2.02 kB
dist/assets/Dashboard-CHbYpKWX.js                             5.91 kB │ gzip:  2.10 kB
dist/assets/Housekeeping-CT_nP9d8.js                          6.04 kB │ gzip:  2.11 kB
dist/assets/OwnerDashboard-D-eBEjeS.js                        6.81 kB │ gzip:  2.09 kB
dist/assets/WalkInCheckInForm-CBbUCJ-y.js                     7.35 kB │ gzip:  2.47 kB
dist/assets/Quotations-KQYXvdeR.js                            7.72 kB │ gzip:  2.56 kB
dist/assets/SettingsSystem-l1X0y53H.js                        7.88 kB │ gzip:  2.49 kB
dist/assets/ReservationForm-DYe4Huwb.js                       9.85 kB │ gzip:  3.35 kB
dist/assets/Reservations-l0E8rrrH.js                         10.43 kB │ gzip:  3.46 kB
dist/assets/authStore-D_EzjumG.js                            10.53 kB │ gzip:  4.24 kB
dist/assets/GuestFieldSection-Ctetvop1.js                    10.76 kB │ gzip:  3.07 kB
dist/assets/QuotationForm-D35R9Bzn.js                        11.28 kB │ gzip:  3.81 kB
dist/assets/QuotationDetail-B77Sy4Ps.js                      11.86 kB │ gzip:  3.17 kB
dist/assets/AdminUsers-DsBTD83e.js                           13.15 kB │ gzip:  3.28 kB
dist/assets/RateCalendar-FGsZ3mVm.js                         13.50 kB │ gzip:  4.54 kB
dist/assets/Stays-z6k2ziKY.js                                13.76 kB │ gzip:  4.08 kB
dist/assets/Assistant-mZuqFKA8.js                            15.87 kB │ gzip:  5.18 kB
dist/assets/Guests-ZU35yYZW.js                               16.07 kB │ gzip:  4.53 kB
dist/assets/Billing-B12W3T2d.js                              17.74 kB │ gzip:  4.88 kB
dist/assets/Restaurant-CUa5v6Gp.js                           21.71 kB │ gzip:  5.61 kB
dist/assets/Rooms-DIqeV5m5.js                                25.46 kB │ gzip:  5.51 kB
dist/assets/it-ChNJib2b.js                                   32.13 kB │ gzip:  8.15 kB
dist/assets/schemas-Bo3zeGyq.js                              69.31 kB │ gzip: 18.48 kB
dist/assets/CalendarPlanning-DfML2JS6.js                    195.75 kB │ gzip: 57.97 kB
dist/assets/api-C5oH9PS7.js                                 206.61 kB │ gzip: 66.32 kB
dist/assets/index-XteVGcxn.js                               284.35 kB │ gzip: 90.49 kB
