# A.SPEC AI-0107 — Auditar observabilidad, healthchecks y alertas operativas
...
## WHY
La operación real requiere visibilidad de disponibilidad, errores y dependencias; hay configuración existente que puede revisarse sin reiniciar servicios.

## WHAT
Mapear healthchecks, endpoints observados, reglas de alerta, destinos y huecos entre servicios definidos en Compose y observabilidad configurada.
...
- Detección de servicios sin señal observable
